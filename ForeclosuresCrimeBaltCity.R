...
mod2AC<- spgm(formula = fmAC, data = baltfc, index = c("CSA2010", "Year"), listw = baltqwmat, model = "within", spatial.error = TRUE, lag = TRUE)
...
sarfemodAC <- spml(formula = fmAC, data = baltfc, index = c("CSA2010", "Year"), listw = baltqlw, model="within", effect = "individual", method = "eigen", na.action = na.fail, quiet = TRUE, zero.policy = NULL, tol.solve = 1e-10 )
summary(sarfemodAC)
...
sarfemodPC <- spml(formula = fmPC, data = baltfc, index = c("CSA2010", "Year"), listw = baltqlw, model="within", effect = "individual", method = "eigen", na.action = na.fail, quiet = TRUE, zero.policy = NULL, tol.solve = 1e-10 )
summary(sarfemodAC)
...
sarfemodVC <- spml(formula = fmVC, data = baltfc, index = c("CSA2010", "Year"), listw = baltqlw, model="within", effect = "individual", method = "eigen", na.action = na.fail, quiet = TRUE, zero.policy = NULL, tol.solve = 1e-10 )
summary(sarfemodAC)
